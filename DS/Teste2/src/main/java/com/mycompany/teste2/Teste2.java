...
class MenuCalculadora {
    ...
    public void avaliarOpcaoEscolhida() {
        ...
        if (this.opcao != 0 && this.opcao<=4) {
            ...
            num2 = conversor.stringToDouble(io.entradaDados(menssagemEntrada));
...
class Calculadora {
    ...
    public void calculadora(double numero01,double numero02,double resultado) {
...
class EntradaSaidaDados {
    public String entradaDados(String menssagemEntrada) {
        return JOptionPane.showInputDialog(menssagemEntrada);
    }
    public void saidaDados(String menssagemSaida) {
        JOptionPane.showInputDialog(null, menssagemSaida);
    }
}
