...
<head>
    ...
    <title>Média Aritmética das Notas</title>
    <link rel="stylesheet" href="/Exercicios/Ex07/Ex07.css">
</head>
<body>
    <form name="media" action="Ex07.php" method="POST">
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($numero1 >= 0 && $numero1 <= 10 &&
            ...
            if ($media >= 6) {
                echo "<p><strong>Nota final: $media (Média >= 6) -> Aluno Aprovado</strong></p>";
            } elseif ($media >= 3) {
                echo "<p><strong>Nota final: $media (Média entre 3 e 6) -> Aluno em Exame</strong></p>";
            } else {
                echo "<p><strong>Nota final: $media (Média < 3) -> Aluno Retido</strong></p>";
            }
        } else {
    ...
    ?>
    <a href="/Exercicios/Ex08/Ex08.php"><button type="button">Próximo →</button></a>
</body>
</html>